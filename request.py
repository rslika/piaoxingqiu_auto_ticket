...
def create_order(show_id, session_id, seat_plan_id, price: int, qty: int, deliver_method, express_fee: int, receiver,
    ...
    if deliver_method == "EXPRESS":
        ...
        data = {"src":"H5",
                "ver":"3.3.5",
                "locationParam":{"locationCityId":"1201"},
                "paymentParam":{"totalAmount":price * qty,
                                "payAmount":price * qty},
                "priceItemParam":[{"applyTickets":[],
                                   "priceItemName":"票款总额",
                                   "priceItemVal":price * qty,
                                   "priceItemType":"TICKET_FEE",
                                   "priceItemSpecies":"SEAT_PLAN",
                                   "direction":"INCREASE",
                                   "priceDisplay":"￥" + str(price * qty)}],
                "items":[{"skus":[{"seatPlanId":seat_plan_id,
                                   "sessionId":session_id,
                                   "showId":show_id,
                                   "skuId":seat_plan_id,
                                   "skuType":"SINGLE",
                          ...
                          "contactParam":{},
                          "many2OneAudience":{},
                          "one2oneAudiences":[{"audienceId":audience_ids[0],
                                               "sessionId":session_id}],
                                               "addressParam":{}}
